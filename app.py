...
def main():
   ...
   """
    ...
    if st.button("About"):
      st.header("Developed by Harshit Pratap")
      st.subheader("student, Department of Computer Engineering")
    html_temp = """
    <div class="" style="background-color:orange;" >
    <div class="clearfix">           
    <div class="col-md-12">
    <center><p style="font-size:20px;color:white;margin-top:10px;">Machine Learning Model on  Support Vector Machine and Random Forest</p></center> 
    </div>
    </div>
    </div>
    """
